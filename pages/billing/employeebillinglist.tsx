...
const FreelancerBillingList = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Employee Billing List'));
    });
                                ...
                                render: (record) => (
                                    <div className="flex items-center gap-3">
                                        <button type="button" className="btn shadow-none bg-[#012d22] text-white rounded-full font-normal font-['Raleway] rtl:font-['Tajawal'] px-3"
                                            onClick={() => {
                                                router.push({
                                                    pathname: `/billing/employeebillinglist/employeebillingdetail`,
                                                    query: { id: record.id, name: `${record?.first_name?.toLowerCase()} ${record?.last_name?.toLowerCase()}` },
                                                });
                                            }}
                                        >
