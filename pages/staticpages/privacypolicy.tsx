...
const EditPrivacyPolicy = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Edit Privacy Policy'));
    });
    ...
    const formik = useFormik({
        initialValues: { title: 'privacy policy', content: '', arabic_content: '' },
        ...
        onSubmit: (values, { resetForm }) => {
            createPage(
                ...
                },
                {
                    onSuccess: () => {
                        resetForm();
                        // router.push('/staticpages/privacypolicy');
                        // ToastMessage('Category created successfully!', 'success', 'Success');
                    },
                    onError: (error) => {
                        console.error('Category creation error:', error);
                        // ToastMessage(t('Failed to create category. Please try again.', 'error', 'Error'));
                    },
                }
            );
        },
            ...
            <div className="pt-5">
                <div className="mb-5 grid grid-cols-1 gap-5 lg:grid-cols-3">
                    <div className="flex flex-col gap-6 lg:col-span-3">
                        <div className="panel">
                            <div className="mb-5">
                                <h5 className="font-['Hermann'] text-2xl font-bold uppercase text-[#012d22] dark:text-white-light">Edit Privacy Policy</h5>
                            </div>
                            ...
                            <div className="mb-5">
                                <form className="space-y-5" onSubmit={formik.handleSubmit}>
                                    ...
                                    <div className="flex items-center gap-2">
                                        <Button text={isCreatingPage ? 'Saving...' : 'Save'} type="submit" bgColor="#012d22" textColor="#ffff" />
