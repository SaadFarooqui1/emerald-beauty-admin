...
const rowData = [
    {
        ...
        editLink: '/staticpages/contactus/formsection',
    }
];
    ...
    return (
        <div>
            <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-2 md:gap-0">
                <div>
                    <h4 className="text-[#012d22] text-2xl font-bold font-['Hermann'] rtl:font-['Tajawal'] rtl:font-medium uppercase dark:text-white-light">{t("Contact Us")}</h4>
                </div>
            </div>
            <div className="panel mt-6">
                <div className="mb-5 flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
                    <h5 className="text-xl font-bold text-[#012d22] font-['Hermann'] rtl:font-['Tajawal'] rtl:font-medium uppercase dark:text-white-light">{t("Contact Us Sections")}</h5>
                </div>
                                ...
                                render: (record) => (
                                    <div className="flex items-center gap-3">
                                        <button
                                            ...
                                            onClick={() => { router.push(`/staticpages/contactus/formsection?id=${record.id}`) }}
                                        >
