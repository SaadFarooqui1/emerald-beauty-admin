...
const EditFAQsContent = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        pageContent: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin lobortis sed sapien in pretium. Donec tincidunt, quam vestibulum ultricies egestas, dolor sem laoreet orci, quis finibus justo quam at nibh. Vestibulum ipsum tortor, suscipit non enim vitae.',
    });
    ...
    const { mutate: updateFaqSec, isLoading: isUpdatingFaqSec } = useUpdateSectionAction();
            ...
            if (id) {
                updateFaqSec(
                    ...
                    },
                    {
                        onSuccess: () => {
                            router.push('/staticpages/home');
                            ErrorToast(t('Faq section updated successfully'), 'success', t('Success')?.toString());
                        },
                        onError: (error) => {
                            ErrorToast(t('Failed to update Faq section. Please try again.'), 'error', t('Error')?.toString());
                        },
                    }
                );
            }
            ...
            <div className="pt-5">
                <div className="mb-5 grid grid-cols-1 gap-5 lg:grid-cols-3">
                    <div className="flex flex-col gap-6 lg:col-span-3">
                        <div className="panel">
                            <div className="mb-5">
                                <h5 className="font-['Hermann'] rtl:font-['Tajawal'] rtl:font-medium text-2xl font-bold uppercase text-[#012d22] dark:text-white-light">{t("Edit FAQs Section")}</h5>
                            </div>
                                ...
                                <form className="space-y-5" onSubmit={formik.handleSubmit}>
                                    ...
                                    <div className="flex items-center gap-2">
                                        {filteredPermissions?.[0].meta.pivot_update === 1 && (
                                            <Button
                                                text={isUpdatingFaqSec ? t("Saving") : t("Save")}
                                                type='submit'
                                                bgColor="#012d22"
                                                textColor="#ffff"
                                            />
...
export default EditFAQsContent;