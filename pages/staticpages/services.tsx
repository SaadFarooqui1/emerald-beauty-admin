...
const rowData = [
    {
        id: 1,
        question: 'Services Section',
        editLink: '/staticpages/services/services',
    },
    {
        id: 2,
        question: 'Banner',
        editLink: '/staticpages/services/banner',
    },
    {
        id: 3,
        question: 'Testimonials',
        editLink: '/staticpages/services/testimonials',
    },
];
    ...
    return (
        <div>
            <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-2 md:gap-0">
                <div>
                    <h4 className="text-[#012d22] text-2xl font-bold font-['Hermann'] rtl:font-medium rtl:font-['Tajawal'] uppercase dark:text-white-light">{t("Our Services")}</h4>
                </div>
            </div>
            <div className="panel mt-6">
                <div className="mb-5 flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
                    <h5 className="text-xl font-bold text-[#012d22] font-['Hermann'] rtl:font-medium rtl:font-['Tajawal'] uppercase dark:text-white-light">{t("Services Sections")}</h5>
                </div>
                                ...
                                render: (record) => {
                                    ...
                                    switch (record.name) {
                                        case "Services Section":
                                            path = "/staticpages/services/services";
                                            break;
                                        case "Banner":
                                            path = "/staticpages/services/banner";
                                            break;
                                        case "Testimonials":
                                            path = "/staticpages/services/testimonials";
                                            break;
                                        default:
                                            path = "Unknown";
                                            break;
